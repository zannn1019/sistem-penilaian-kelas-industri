    ...
    <div class="w-full h-full p-3 flex flex-col">
        ...
        <div class="w-full h-full px-7 max-sm:px-0 flex flex-col gap-2">
            <div
                ...
                <a href=""
                    class="border-white border self-end justify-self-end p-2 aspect-square rounded-circle flex justify-center items-center">
                        ...
                        <div class="flex flex-col py-5 justify-center">
                            <div class="flex flex-col border-l max-sm:border-none border-black gap-1 px-5">
                                <div class="w-full">
                                    ...
                                    <span>{{ $tugas['tugas']['ternilai'] }}</span>
                                    <span class="text-xs">/ {{ $tugas['tugas']['total'] }}</span>
                                ...
                                <div class="w-full flex gap-1 items-center">
                                    ...
                                    <span>8</span>
                                    <span class="text-xs">/ {{ $tugas['kuis']['total'] }}</span>
                                ...
                                <div class="w-full flex gap-1 items-center">
                                    ...
                                    <span>8</span>
                                    <span class="text-xs">/ {{ $tugas['ujian']['total'] }}</span>
                                            ...
                                            @if ($mapel->tugas->where('id_kelas', $info_kelas->id)->count())
                                                @foreach ($mapel->tugas->where('id_kelas', $info_kelas->id) as $tugas)
                                                    <div class="p-2 grid grid-cols-3 text-center text-sm w-full ">
                                                        <h1>{{ $tugas->nama }}</h1>
                                                        <h1>75</h1>
                                                        <h1>{{ $tugas->nilai->value('nilai') ?? 'Belum Dinilai' }}</h1>
                                                    </div>
                                                @endforeach
                                            @else
