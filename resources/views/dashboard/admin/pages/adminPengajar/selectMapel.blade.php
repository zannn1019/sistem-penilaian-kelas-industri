                        ...
                        <div class="w-full h-full grid grid-cols-2 gap-4 justify-between items-center text-black">
                            ...
                            <div class="w-full flex flex-col gap-1">
                                <div class="w-full text-white flex items-center gap-1">
                                    ...
                                    <span class="text-black">{{ $mapel->tugas()->where('tipe', 'tugas')->count() }}</span>
                                ...
                                <div class="w-full text-white flex items-center gap-1">
                                    ...
                                    <span class="text-black">{{ $mapel->tugas()->where('tipe', 'quiz')->count() }}</span>
                                ...
                                <div class="w-full text-white flex items-center gap-1">
                                    ...
                                    <span
                                        class="text-black">{{ $mapel->tugas()->where(function ($query) {
