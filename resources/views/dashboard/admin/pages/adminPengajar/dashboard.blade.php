                ...
                <div class="statistik p-5 flex flex-col gap-1 max-sm:w-full">
                    ...
                    <div class="counter flex flex-col text-sm gap-2">
                        ...
                        <div class="w-full text-white flex items-center gap-1">
                            ...
                            <span>{{ $status_tugas['latihan']['ternilai'] }}</span>
                            <span class="text-xs">/ {{ $status_tugas['latihan']['total'] }}</span>
                        ...
                        <div class="w-full text-white flex items-center gap-1">
                            ...
                            <span>{{ $status_tugas['assessment']['ternilai'] }}</span>
                            <span class="text-xs">/ {{ $status_tugas['assessment']['total'] }}</span>
