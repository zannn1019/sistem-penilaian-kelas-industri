                ...
                <div class="w-full flex flex-col text-xs">
                    <div class="text-sm max-sm:hidden breadcrumbs p-0">
                        <ul>
                            ...
                            <li>Dashboard Pengajar</li>
                        </ul>
                    </div>
                    <h1 class="text-3xl font-semibold max-sm:text-sm">Dashboard Pengajar</h1>
                </div>
            </div>
                ...
                <div class="statistik p-5 flex flex-col gap-1 max-sm:w-full">
                    ...
                    <div class="counter flex flex-col text-sm gap-2">
                        ...
                        <div class="w-full text-white flex items-center gap-1">
                            ...
                            <span>{{ $status_tugas['PTS']['ternilai'] }}</span>
                            <span class="text-xs">/ {{ $status_tugas['PTS']['total'] }}</span>
                        ...
                        <div class="w-full text-white flex items-center gap-1">
                            ...
                            <span>{{ $status_tugas['PAS']['ternilai'] }}</span>
                            <span class="text-xs">/ {{ $status_tugas['PAS']['total'] }}</span>
