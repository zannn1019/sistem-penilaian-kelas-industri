...
@else
    <div class="max-sm:hidden sidebar h-full w-28 flex bottom-0 left-0 justify-between flex-col items-center ">
        ...
        <div class="page_link text-white flex flex-col gap-10 ">
            <a href="" class="flex flex-col gap-2 text-center text-2xl justify-center items-center">
                ...
                <h1 class="text-2xs leading-3 max-sm:hidden">DIBUANG</h1>
            </a>
            <a href="" class="flex flex-col gap-2 text-center text-2xl justify-center items-center">
                <i class="fa-solid fa-print"></i>
                <h1 class="text-2xs leading-3 max-sm:hidden">CETAK RAPORT</h1>
    ...
    <div
        class="max-sm:flex z-50 hidden w-full fixed h-20 bottom-0 left-0 items-center justify-between p-5 pointer-events-none">
        ...
        <div
            class="user text-white bg-bluesea-500 py-2 px-4 rounded-box shadow-xl text-2xl flex flex-col justify-center items-center gap-3 max-sm:flex-row pointer-events-auto">
            <a href="" class="bg-darkblue-500 px-3 py-2 rounded-full shadow-lg">
                <i class="fa-solid fa-user"></i>
            </a>
            <a href="" class="">
