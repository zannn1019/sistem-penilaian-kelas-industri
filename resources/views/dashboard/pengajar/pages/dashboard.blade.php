...
@section('content')
    <div class="w-full h-full flex flex-col overflow-y-auto overflow-x-hidden gap-5 p-5">
        <div class="w-full flex max-sm:flex-col max-md:flex-col gap-5 pb-2">
                ...
                <div class="statistik p-5 flex flex-col gap-1 max-sm:w-full">
                    ...
                    <div class="counter flex flex-col text-sm gap-2">
                        ...
                        <div class="w-full text-white flex items-center gap-1">
                            ...
                            <span>10</span>
                            <span class="text-xs">/ 20</span>
                            <span class="text-xs text-tosca-500">PTS</span>
                        </div>
                        <div class="w-full text-white flex items-center gap-1">
            ...
            <div class="w-6/12 max-sm:w-full max-md:w-full h-full ">
                <div
                    ...
                    <h1 class="text-8xl ">{{ $kelas }}</h1>
                    <h1 class="text-2xl">Kelas <br> Industri</h1>
                    <a href="" class="btn text-white rounded-6xl absolute right-3 bottom-2 px-5 capitalize">Detail <i
                            class="fa-solid fa-chevron-right text-xs"></i></a>
                </div>
            </div>
        </div>
        <div class="w-full h-1/3 grid grid-cols-3 max-sm:grid-cols-1 max-md:grid-cols-1 text-black gap-5 p-2">
            <a href="" class="box p-2">
                <h1 class="font-bold">Kelas Industri 1</h1>
                <div class="box-content w-11/12 h-44 bg-tosca-200 rounded-2xl flex flex-col gap-2 p-4 shadow-lg">
                    <div class="info-sekolah flex justify-between items-center w-full h-10">
                        <div class="nama-kelas">
                            <span class="text-xs font-semibold ">SMKN 2 Cimahi</span>
                            <h1 class="font-bold leading-3 text-2xl">
                                Kelas DKV</h1>
                        </div>
                        <div class="logo avatar h-full">
                            <img src="{{ asset('img/smkn2.png') }}" alt="" class="w-full h-full">
                        </div>
                    </div>
                    <div class="w-full h-full grid grid-cols-2 gap-2 justify-between items-center">
                        <img src="{{ asset('img/dkv.png') }}" alt="" class="w-full">
                        <div class="info flex flex-col text-xs gap-2">
                            <span class="font-bold">Semester Genap</span>
                            <span><i class="fa-solid fa-chalkboard"></i> XII-DKV-A</span>
                            <span><i class="fa-solid fa-users"></i> 36 Siswa</span>
                        </div>
                    </div>
                </div>
            </a>
