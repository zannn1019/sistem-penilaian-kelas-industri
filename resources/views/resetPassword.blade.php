...
<body class="w-full h-screen flex justify-center flex-col gap-5 items-center overflow-hidden bg-bg bg-cover relative"
    data-theme="light">
    ...
    <form class="w-full items-center flex flex-col gap-4 max-w-xs bg-white" action="{{ route('password.update') }}"
        method="POST">
        @csrf
